...
from debian_markdown import get_parse_debian
from debian_markdown import convert_tag_to_markdown, markdown_file
...
class TestDebianMarkdownFunctions(unittest.TestCase):
    ...
    def test_get_parse_debian(self, mock_get):
        ...
        self.assertEqual(
            str(context.exception), "Failed to fetch the Debian Wiki News page: 404"
        )
